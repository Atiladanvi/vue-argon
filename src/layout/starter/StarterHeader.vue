<template>
  <header class="header-global">
    <base-nav class="navbar-main" transparent type="" effect="light" expand>
      ...
      <div class="align-items-lg-center ml-lg-auto">
        <scrollactive
        ...
        >
          <ul class="navbar-nav">
            <li class="nav-item">
              <a href="#noticias" class="nav-link scrollactive-item" data-toggle="dropdown" role="button">
                <span class="nav-link-inner--text">Notícias</span>
              </a>
            </li>
            <li class="nav-item">
              <a href="#estatisticas" class="nav-link scrollactive-item" data-toggle="dropdown" role="button">
                <span class="nav-link-inner--text">Estatísticas</span>
              </a>
            </li>
            <li class="nav-item">
              <a href="#informacoes" class="nav-link scrollactive-item" data-toggle="dropdown" role="button">
                <span class="nav-link-inner--text">Informações</span>
              </a>
            </li>
            <li class="nav-item">
              <a href="#servicos" class="nav-link scrollactive-item" data-toggle="dropdown" role="button">
                <span class="nav-link-inner--text">Serviços</span>
              </a>
            </li>
            <li class="nav-item">
              <a href="#nfse" class="nav-link scrollactive-item" data-toggle="dropdown" role="button">
                <span class="nav-link-inner--text">Nfse</span>
              </a>
            </li>
            <li class="nav-item">
              <a href="#contato" class="nav-link scrollactive-item" data-toggle="dropdown" role="button">
